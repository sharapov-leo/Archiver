...
DESCRIPTION
    The archiver reduces the size of named files using bvt + mft + rle. Whenever possible, each file is replaced by one with the extension .sharp. If a filename is "-", the standard input is compressed to the standard output.
    -c
